...
const countryToLiveInForSarah = function (language, isIceland, population, country){
    if (language.toLowerCase() === 'english' && !isIceland && population < 50) {
...
countryToLiveInForSarah('English', false, 40, 'Malta');